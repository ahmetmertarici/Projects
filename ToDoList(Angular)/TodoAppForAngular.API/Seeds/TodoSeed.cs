...
public class TodoSeed
{
    public static void AddTodosDummy(AppDbContext context)
    {
        ...
        context.Todos!.Add(new() { Content = "yapılacak 3", Created = DateTime.Now, IsCompleted = false });
        context.Todos!.Add(new() { Content = "yapılacak 4", Created = DateTime.Now, IsCompleted = false });
        context.Todos!.Add(new() { Content = "yapılacak 5", Created = DateTime.Now, IsCompleted = false });
        context.SaveChanges();
    }
}